<template>
    <div class="container">
        ...
        <nav class="nav">
            <ul class="pagination">
                <li v-if="currentPage !==1" class="page-item"><a href="#" class="page-link"  @click="getTodos(currentPage-1)"><i class="fa-solid fa-chevron-left"></i></a></li>
               ...
               <li v-for="page in numberOfPages" :key="page" class="page-item" :class="currentPage===page ? 'active' : ''">
                ...
                <li v-if="numberOfPages !== currentPage" class="page-item"><a href="#" class="page-link" @click="getTodos(currentPage+1)"><i class="fa-solid fa-chevron-right"></i></a></li>
            </ul>
        </nav>
    </div>
</template>
